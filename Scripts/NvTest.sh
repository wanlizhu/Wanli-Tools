...
if [[ $1 == driver || $1 == drivers ]]; then 
    ...
    if [[ $WZHU_PUSHBUF == 1 ]]; then 
        exportEnvs+=" export __GL_ac12fede=$(( 0x00000001 | 0x00000002 | 0x00000080 | 0x00000100 | 0x00010000 )); export __GL_8FCB2E8=100; export __GL_6635F0C4=100; export __GL_ac12fedf=/tmp/pushbuffer-viewperf-$2-subtest$3-on-$(hostname)-%d.txt; "
    fi 
