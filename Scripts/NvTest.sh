...
if [[ $1 == env ]]; then
    if [[ -z $2 ]]; then 
        ...
        function wzhu-enable-pcsampler {
            ...
            nvreg -dPS_HULL_SHADER_DUMP -dPS_VERTEX_SHADER_DUMP -dPS_PUSHBUFFER_DUMP_FILENAME -dPS_PUSHBUFFER_DUMP_FLAGS -dPS_CYCLESTATS_PROFILER_FLAGS -dPS_CYCLESTATS_MERGE_FLAGS -dPS_PIXEL_SHADER_STATS_FLAGS -dPS_PIXEL_SHADER_DUMP_FLAGS -dPS_VERTEX_SHADER_STATS_FLAGS -dPS_VERTEX_SHADER_DUMP_FLAGS -dPS_GEOMETRY_SHADER_DUMP_FLAGS -dPS_COMPUTE_SHADER_DUMP_FLAGS -dPS_PIXEL_SHADER_DUMP -dPS_COMPUTE_SHADER_DUMP -dPS_CYCLESTATS_PM_CONFIG -dPS_CYCLESTATS_FLAGS2 OGL_APP_CLAW=DISABLED PS_CYCLESTATS=1 PS_DEBUG_FILE=1 OGL_THREAD_CONTROL=2 PS_FILE_PATH=$HOME/PCSampler PS_CYCLESTATS_DIRECTORY=$HOME/PCSampler VK_EXPOSE_DEBUG_LABEL=1 PS_CYCLESTATS_LAUNCH_FLAGS=IGNORE_COMPUTE_ONLY OGL_SHADER_DISK_CACHE=DISABLE VK_QUEUES_SINGLE_STATE=1 "PS_CYCLESTATS_FLAGS=PSHADER|VSHADER|RT|TAGS|APPSTATE|COLORWRITE|DEPTHTEST|STENCILENABLE|COMPUTE" PS_CYCLESTATS_CAPTURE_FLAGS="USE_LARGE_CAPTURE_BUFFER" PS_CYCLESTATS_START_FRAME=$index PS_CYCLESTATS_END_FRAME=$((index+1)) "PS_CYCLESTATS_XFLAGS=SORT_BY_TIME|SKIP_DEAD_FRAMES|MERGE_3DSTATEBUCKETS" PS_PIXEL_SHADER_DUMP=1 "PS_PIXEL_SHADER_DUMP_FLAGS=DUMP_APP_CREATED_SHADERS|DUMP_HAND_TUNED_SHADERS|DUMP_DSR_SHADERS|DUMP_CUBEMAP_SHADERS|DUMP_DRIVER_CALC_SHADERS|DUMP_NVINST|DUMP_NVVM|DUMP_SAMPLER_STATE|DUMP_TEXTURE_STATE|DUMP_ANNOTATED_NVINST|DUMP_ANNOTATED_SASS|DUMP_ANNOTATED_DXBC|DUMP_GENERATE_SOURCE_CODE|DUMP_CONST_HISTOGRAMS|DUMP_RENDERTARGET_STATE|DUMP_DEPTHTARGET_STATE|DUMP_SHADER_MEASURE_TIME|DUMP_SHADER_MEASURE_SPEED|DUMP_SHADER_MEASURE_STALLS|DUMP_SHADER_MEASURE_PCSAMPLER|DUMP_SHADER_SORT_COLLECTIONS|DUMP_SHADER_USE_PCSAMPLER_FOR_USAGE|DUMP_SHADER_COMPILE_TIME" PS_VERTEX_SHADER_DUMP=1 "PS_VERTEX_SHADER_DUMP_FLAGS=DUMP_APP_CREATED_SHADERS|DUMP_HAND_TUNED_SHADERS|DUMP_DSR_SHADERS|DUMP_CUBEMAP_SHADERS|DUMP_DRIVER_CALC_SHADERS|DUMP_NVINST|DUMP_NVVM|DUMP_SAMPLER_STATE|DUMP_TEXTURE_STATE|DUMP_ANNOTATED_NVINST|DUMP_ANNOTATED_SASS|DUMP_ANNOTATED_DXBC|DUMP_GENERATE_SOURCE_CODE|DUMP_CONST_HISTOGRAMS|DUMP_RENDERTARGET_STATE|DUMP_DEPTHTARGET_STATE|DUMP_SHADER_MEASURE_TIME|DUMP_SHADER_MEASURE_SPEED|DUMP_SHADER_MEASURE_STALLS|DUMP_SHADER_MEASURE_PCSAMPLER|DUMP_SHADER_SORT_COLLECTIONS|DUMP_SHADER_USE_PCSAMPLER_FOR_USAGE|DUMP_SHADER_COMPILE_TIME" PS_COMPUTE_SHADER_DUMP=1 "PS_COMPUTE_SHADER_DUMP_FLAGS=DUMP_APP_CREATED_SHADERS|DUMP_HAND_TUNED_SHADERS|DUMP_DSR_SHADERS|DUMP_DRIVER_CALC_SHADERS|DUMP_NVINST|DUMP_NVVM|DUMP_SAMPLER_STATE|DUMP_TEXTURE_STATE|DUMP_ANNOTATED_NVINST|DUMP_ANNOTATED_SASS|DUMP_ANNOTATED_DXBC|DUMP_GENERATE_SOURCE_CODE|DUMP_CONST_HISTOGRAMS|DUMP_RENDERTARGET_STATE|DUMP_DEPTHTARGET_STATE|DUMP_SHADER_MEASURE_TIME|DUMP_SHADER_MEASURE_SPEED|DUMP_SHADER_MEASURE_STALLS|DUMP_SHADER_MEASURE_PCSAMPLER|DUMP_SHADER_SORT_COLLECTIONS|DUMP_SHADER_USE_PCSAMPLER_FOR_USAGE|DUMP_SHADER_COMPILE_TIME" PS_UCODE_SHADER_DUMP=1 >/tmp/enable-pcsampler || return 1
            #nvreg -dPS_HULL_SHADER_DUMP -dPS_VERTEX_SHADER_DUMP -dPS_PUSHBUFFER_DUMP_FILENAME -dPS_PUSHBUFFER_DUMP_FLAGS -dPS_CYCLESTATS_PROFILER_FLAGS -dPS_CYCLESTATS_MERGE_FLAGS -dPS_PIXEL_SHADER_STATS_FLAGS -dPS_PIXEL_SHADER_DUMP_FLAGS -dPS_VERTEX_SHADER_STATS_FLAGS -dPS_VERTEX_SHADER_DUMP_FLAGS -dPS_GEOMETRY_SHADER_DUMP_FLAGS -dPS_COMPUTE_SHADER_DUMP_FLAGS -dPS_PIXEL_SHADER_DUMP -dPS_COMPUTE_SHADER_DUMP -dPS_CYCLESTATS_PM_CONFIG -dPS_CYCLESTATS_FLAGS2 OGL_APP_CLAW=DISABLED PS_CYCLESTATS=1 PS_DEBUG_FILE=1 OGL_THREAD_CONTROL=2 PS_FILE_PATH=$HOME/PCSampler PS_CYCLESTATS_DIRECTORY=$HOME/PCSampler VK_EXPOSE_DEBUG_LABEL=1 PS_CYCLESTATS_LAUNCH_FLAGS=IGNORE_COMPUTE_ONLY OGL_SHADER_DISK_CACHE=DISABLE VK_QUEUES_SINGLE_STATE=1 "PS_CYCLESTATS_FLAGS=PSHADER|VSHADER|RT|TAGS|APPSTATE|COLORWRITE|DEPTHTEST|STENCILENABLE|COMPUTE" PS_CYCLESTATS_CAPTURE_FLAGS="USE_LARGE_CAPTURE_BUFFER" PS_CYCLESTATS_START_FRAME=$index PS_CYCLESTATS_END_FRAME=$((index+1)) "PS_CYCLESTATS_XFLAGS=SORT_BY_TIME|SKIP_DEAD_FRAMES|MERGE_3DSTATEBUCKETS" PS_PIXEL_SHADER_DUMP=1 "PS_PIXEL_SHADER_DUMP_FLAGS=DUMP_NVINST|DUMP_NVVM|DUMP_GENERATE_SOURCE_CODE|DUMP_SHADER_MEASURE_PCSAMPLER" PS_VERTEX_SHADER_DUMP=1 PS_VERTEX_SHADER_DUMP_FLAGS=40080120 PS_COMPUTE_SHADER_DUMP=1 "PS_COMPUTE_SHADER_DUMP_FLAGS=DUMP_APP_CREATED_SHADERS|DUMP_HAND_TUNED_SHADERS|DUMP_DSR_SHADERS|DUMP_DRIVER_CALC_SHADERS|DUMP_ZERO_USAGE_SHADERS|DUMP_NVINST|DUMP_NVVM|DUMP_SHADER_MEASURE_PCSAMPLER|DUMP_GENERATE_SOURCE_CODE" PS_UCODE_SHADER_DUMP=1 >/tmp/enable-pcsampler || return 1
    ...
    if [[ $WZHU_PCSAMPLER == 1 ]]; then 
        wzhu-enable-pcsampler || exit 1
    fi 
