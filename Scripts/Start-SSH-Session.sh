...
hostsInLab[proxy]="10.176.11.106"
hostsInLab[horizon5]="172.16.178.123"
hostsInLab[horizon6]="172.16.177.182"
hostsInLab[horizon7]="172.16.177.216"

if [[ ! -z "${hostsInLab[$1]+_}" ]]; then
